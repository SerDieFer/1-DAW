namespace Exercise_4
{
    partial class fAlumnManagement
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.alumnosAdminTableAdapter = new Exercise_4.HighschoolDataSetTableAdapters.AlumnosTableAdapter();
            ...
            // txtbAlumnCourse
            // 
            this.txtbAlumnCourse.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.alumnosAdminBindingSource, "Codigo", true));
            ...
            // txtbAlumnPassword
            // 
            this.txtbAlumnPassword.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.alumnosAdminBindingSource, "Contraseña", true));
            ...
            // txtbAlumnID
            // 
            this.txtbAlumnID.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.alumnosAdminBindingSource, "DNI", true));
            ...
            // txtbAlumnName
            // 
            this.txtbAlumnName.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.alumnosAdminBindingSource, "Nombre", true));
            ...
            // txtbAlumnAdress
            // 
            this.txtbAlumnAdress.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.alumnosAdminBindingSource, "Direccion", true));
            ...
            // txtbAlumnPhone
            // 
            this.txtbAlumnPhone.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.alumnosAdminBindingSource, "Tlf", true));
            ...
            // txtbAlumnSurnames
            // 
            this.txtbAlumnSurnames.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.alumnosAdminBindingSource, "Apellido", true));
            ...
            // 
            this.alumnosAdminBindingSource.DataMember = "Alumnos";
            this.alumnosAdminBindingSource.DataSource = this.highschoolDataSet;
            // 
            // alumnosAdminTableAdapter
            // 
            this.alumnosAdminTableAdapter.ClearBeforeFill = true;
            // 
            // fAlumnManagement
            // 
        ...
        private HighschoolDataSetTableAdapters.AlumnosTableAdapter alumnosAdminTableAdapter;
    }
}